...
class TopFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 870,365 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
...
class TopPanel ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 850,362 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        self.account_addr = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 504,-1 ), wx.TE_READONLY|wx.BORDER_NONE )
        self.account_addr.SetFont( wx.Font( 14, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )

        bSizer5.Add( self.account_addr, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
