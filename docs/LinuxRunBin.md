...
```
UniblowFile=Uniblow-linux-x86_64-1.5.0
...
```
torsocks ./Uniblow-linux-x86_64-1.5.0
```
...
If nothing happens after some seconds, open a terminal in the current directory and type `./Uniblow-linux-x86_64-1.5.0`
