...
[Uniblow program](https://uniblow.org/dist/Uniblow-linux-x86_64-2.6.0)  
 and its  
[PGP signature](https://uniblow.org/dist/Uniblow-linux-x86_64-2.6.0.sig)

**Or** using the terminal, in Tails you may need to prepend *torsocks* to these commands :
```
wget https://uniblow.org/dist/Uniblow-linux-x86_64-2.6.0
wget https://uniblow.org/dist/Uniblow-linux-x86_64-2.6.0.sig
```
...
```
UniblowFile=Uniblow-linux-x86_64-2.6.0
...
```
torsocks ./Uniblow-linux-x86_64-2.6.0
```
...
If nothing happens after some seconds, open a terminal in the current directory and type `./Uniblow-linux-x86_64-2.6.0`
