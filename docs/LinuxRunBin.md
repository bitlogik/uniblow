...
[Uniblow program](https://uniblow.org/dist/Uniblow-linux-x86_64-2.7.3)  
 and its  
[PGP signature](https://uniblow.org/dist/Uniblow-linux-x86_64-2.7.3.sig)

**Or** using the terminal, in Tails you may need to prepend *torsocks* to these commands :

```
wget https://uniblow.org/dist/Uniblow-linux-x86_64-2.7.3
wget https://uniblow.org/dist/Uniblow-linux-x86_64-2.7.3.sig
```
...
```
UniblowFile=Uniblow-linux-x86_64-2.7.3
...
```
torsocks ./Uniblow-linux-x86_64-2.7.3
```
...
If nothing happens after some seconds, open a terminal in the current directory and type `./Uniblow-linux-x86_64-2.7.3`
