...
[Uniblow program](https://uniblow.org/dist/Uniblow-linux-x86_64-1.6.2)  
 and its  
[PGP signature](https://uniblow.org/dist/Uniblow-linux-x86_64-1.6.2.sig)

**Or** using the terminal, in Tails you may need to prepend *torsocks* to these commands :
```
wget https://uniblow.org/dist/Uniblow-linux-x86_64-1.6.2
wget https://uniblow.org/dist/Uniblow-linux-x86_64-1.6.2.sig
```
...
```
UniblowFile=Uniblow-linux-x86_64-1.6.2
...
```
torsocks ./Uniblow-linux-x86_64-1.6.2
```
...
If nothing happens after some seconds, open a terminal in the current directory and type `./Uniblow-linux-x86_64-1.6.2`
